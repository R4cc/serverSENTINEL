# serverSENTINEL 1.0.3 Release Notes

serverSENTINEL 1.0.3 is the current stable release line for the Docker-based Minecraft server panel.
...
- Upgrade the panel and all node agents to `nl2109/serversentinel:1.0.3`. Mixed panel/node versions are intended only as a short upgrade window.
