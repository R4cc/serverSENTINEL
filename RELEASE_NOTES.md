# serverSENTINEL 1.2.1 Release Notes

serverSENTINEL 1.2.1 is the current stable release line for the Docker-based Minecraft server panel.
...
- Upgrade the panel and all node agents to `nl2109/serversentinel:1.2.1`. Mixed panel/node versions are intended only as a short upgrade window.
...
- The published Docker workflow tags main builds as `latest`, `1.2.1`, and the commit SHA.
