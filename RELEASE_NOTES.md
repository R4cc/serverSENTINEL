# serverSENTINEL 1.0.0 Release Notes
...
- Upgrade the panel and all node agents to `nl2109/serversentinel:1.0.0`. Mixed panel/node versions are intended only as a short upgrade window.
...
- The published Docker workflow tags main builds as `latest`, `1.0.0`, and the commit SHA.
